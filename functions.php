...
function sp_br_fe_17_widgets_init() {
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Footer', 'sp_br_fe_17' ),
		'id'            => 'Footer',
		'description'   => esc_html__( 'Add widgets here.', 'sp_br_fe_17' ),
		'before_widget' => '<section id="%1$s" class="sponsorLogo widget %2$s">',
		'after_widget'  => '</section>',
		'before_title'  => '<h2 class="widget-title">',
		'after_title'   => '</h2>',
	) );
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Overlay', 'sp_br_fe_17' ),
		'id'            => 'overlay',
		'description'   => esc_html__( 'Add widgets here.', 'sp_br_fe_17' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Programm_pdf', 'sp_br_fe_17' ),
		'id'            => 'programmpdf',
		'description'   => esc_html__( 'Add widgets here.', 'sp_br_fe_17' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
	...
	register_sidebar( array(
		'name'          => esc_html__( 'SlideMap', 'sp_br_fe_17' ),
		'id'            => 'slide-map',
		'description'   => esc_html__( 'Add widgets here.', 'sp_br_fe_17' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
